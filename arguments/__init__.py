...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        # Spectral-GS parameters
        self.use_spectral_loss = False
        self.lambda_spectral_entropy = 0.01
        self.lambda_spectral_l1 = 0.01
        self.spectral_loss_from_iter = 500
        self.use_spectral_densification = False
